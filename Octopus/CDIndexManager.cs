    ...
    class CDIndexManager
    {
                ...
                if ((FolderTree != null) && (FolderTree.SelectedNode != null)) {
                    ...
                    if (fid != null) {
                        ...
                        try {
                            ...
                            /*
                            ImageList oldImageList = itemList.SmallImageList;
                            itemList.SmallImageList = Shell.GetSystemImagelist(Shell.FileIconSize.Small, false);
        ...
        private void saveAsCsv(string filePath) {
            try {
                ...
                // MessageBox.Show("Error saving file " + filePath + ". Error message: " + e.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop);
        ...
        CdInDatabaseList cdsInDatabase; // = new CdInDatabaseList();
        ...
        internal void ReadCd() {
            ...
            try {
                ...
                // MessageBox.Show("An IO error occured: " + e.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        /*
		internal void Search(string fileMask, List<ListViewItem> list) {
			Regex r = new Regex(Algorithms.Convert.ToRegex(fileMask), RegexOptions.Compiled | RegexOptions.IgnoreCase);
			
			//searchResultList.BeginUpdate();
			//try {
                //searchResultList.Items.Clear();
                list.Clear();
				cdsInDatabase.InsertFilesToList(r, list);
                updateSearchListImages();
			//}
			//finally {
				//searchResultList.EndUpdate();
			//}
		}
         */

        /// <summary>
        /// Wstawia do listy elementy zgodne z kryterium wyszukiwania.
        /// </summary>
        /// <param name="fileMask"></param>
        /// <param name="dateFrom"></param>
        /// <param name="dateTo"></param>
        /// <param name="sizeFrom">Dolna granica rozmiaru w bajtach lub null.</param>
        /// <param name="sizeTo">Górna granica rozmiaru w bajtach lub null.</param>
        ...
        internal void Search(string fileMask, DateTime? dateFrom, DateTime? dateTo, long? sizeFrom, long? sizeTo, string keywords, bool allKeywordsNeeded, List<ListViewItem> list) {
            ...
            try {
                ...
                Debug.WriteLine("fileMask: " + fileMask);
