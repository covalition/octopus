    ...
    public partial class FrmMain : Form
    {
        ...
        private void cmCheckForUpdates_Click(object sender, EventArgs e) {
            try {
                if (ApplicationDeployment.IsNetworkDeployed) {
                    ...
                    if (info.UpdateAvailable) {
                        ...
                        if (!info.IsUpdateRequired) {
                            DialogResult dr = MessageBox.Show($"An update ({info.AvailableVersion.ToString()}) is available. Would you like to update the application now?", "Update Available", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
                ...
                MessageBox.Show(ex.Message, ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
        }
        ...
        private TreeNode getSelectedLogicalFolderTvItem() => tvLogicalFolders.SelectedNode;
        ...
        /* TODO: check the deserializing from memory
